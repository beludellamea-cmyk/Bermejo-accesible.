...
En Inicio, Material y Docentes hay un botón flotante **«Ayuda por voz»**, junto al acceso visual a «Necesito ayuda». Al abrirlo da una bienvenida escrita y hablada. Solo escucha al pulsar «Hablar», reconoce una frase en español y apaga el micrófono después; «Detener micrófono» permite cancelarlo antes. La instrucción reconocida y las respuestas se muestran por escrito. Ejemplos: «adaptar mi material», «subir una foto», «subir un PDF», «ir a docentes», «ir a normativa», «volver al inicio», «agrandar la letra», «alto contraste», «escuchar el material», «leer por partes», «ver imágenes» y «necesito ayuda». Lleva al campo o botón real; si falta material cargado, explica el paso previo. También hay un botón para escuchar de nuevo la respuesta. No es un chatbot de preguntas abiertas ni escribe mensajes por dictado. El permiso de micrófono lo solicita el navegador; algunos navegadores no ofrecen reconocimiento o procesan el audio mediante su propio servicio, así que evitá datos sensibles. Los botones y lectores de pantalla permanecen disponibles. **La sección de traducciones no tiene micrófono**; sus lenguas necesitan pruebas específicas con hablantes.
